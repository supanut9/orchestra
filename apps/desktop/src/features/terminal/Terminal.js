...
// ── Component ──────────────────────────────────────────────────────────────────
export function Terminal({ ptyId, isActive = true }) {
    ...
    return (_jsx("div", { ref: containerRef, className: "h-full w-full overflow-hidden bg-[#0d0d0d]", onKeyDown: handleKeyDown, 
